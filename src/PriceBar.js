...
import {X ,Filter} from "lucide-react"; // Import icons
...
const PriceBar = ({ onPriceChange, productList }) => {
  ...
  return (
    ...
    <>
      ...
      <div className="relative d-flex justify-content-center z-50 p-4 md:hidden" style={{  marginBottom: "15px" }}>
        <button
      ...
      <div className="p-4 bg-white w-55 hidden md:block">
        {/* Header */}
